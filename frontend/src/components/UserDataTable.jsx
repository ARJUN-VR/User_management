...
import {useAdminDeleteMutation,useAdminEditMutation } from "../../AdminSlices/adminApiSlices.js";
...
const UsersDataTable = ({ users }) => {
  ...
  const [deleteUser, { isLoading }] = useAdminDeleteMutation();
  const [updateUserByAdmin, { isLoading: isUpdating }] = useAdminEditMutation();
